...
class CourseViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    @action(detail=True, methods=['get'], authentication_classes=[BasicAuthentication], serializer_class=CourseWithContentsSerializer, permission_classes=[IsAuthenticated, IsEnrolled])
